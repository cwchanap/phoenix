...
describe('Phoenix scaffold', () => {
  ...
  test('ignores caches generated by required static and native checks', () => {
    for (const generated of ['.svelte-check/probe', 'src-tauri/gen/schemas/probe.json']) {
