...
- GUT **9.7.1**, not committed; `tools/verify-clean.sh` fetches the tagged upstream tarball into its temp archive and validates the pinned sha256 checksum `6da99c4e9228d9bec3fb4bd1730a487770a989f0f511dac82a2897a964613385` before extracting (amended 2026-08-23: addons left the git tree by owner decision; clean runs need network).
